...
# 1 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_nif.h" 1
# 31 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_nif.h"
# 1 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_drv_nif.h" 1
# 28 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_drv_nif.h"
typedef struct {
...
# 90 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_drv_nif.h"
# 1 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_int_sizes_config.h" 1
# 91 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_drv_nif.h" 2
# 113 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_drv_nif.h"
typedef unsigned long ErlNapiUInt64;
typedef signed long ErlNapiSInt64;
# 127 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_drv_nif.h"
typedef ErlNapiUInt64 ErlNapiUInt;
typedef ErlNapiSInt64 ErlNapiSInt;
# 159 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_drv_nif.h"
...
# 160 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_drv_nif.h" 2
...
# 32 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_nif.h" 2
# 89 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_nif.h"
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdlib.h" 1 3 4
# 64 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdlib.h" 3 4
...
# 90 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_nif.h" 2
...
# 91 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_nif.h" 2
...
# 92 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_nif.h" 2
...
# 183 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_nif.h"
typedef enum
{
    ERL_NIF_RT_CREATE = 1,
...
typedef struct erl_nif_io_vec {
    ...
    SysIOVec small_iov[16];
    void *small_ref_bin[16];
} ErlNifIOVec;
...
# 333 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_nif.h"
typedef enum {
    ERL_NIF_OPT_DELAY_HALT = 1,
    ERL_NIF_OPT_ON_HALT = 2
} ErlNifOption;
# 362 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_nif.h"
...
# 1 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_nif_api_funcs.h" 1
# 33 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_nif_api_funcs.h"
extern void* enif_priv_data (ErlNifEnv*);
extern void* enif_alloc (size_t size) __attribute__((malloc)) __attribute__((alloc_size(1))) __attribute__((warn_unused_result)) __attribute__((warn_unused_result));
extern void enif_free (void* ptr);
...
extern ErlNifMutex* enif_mutex_create (char *name) __attribute__((warn_unused_result));
extern void enif_mutex_destroy (ErlNifMutex *mtx);
...
extern ErlNifCond* enif_cond_create (char *name) __attribute__((warn_unused_result));
extern void enif_cond_destroy (ErlNifCond *cnd);
...
extern ErlNifRWLock* enif_rwlock_create (char *name) __attribute__((warn_unused_result));
extern void enif_rwlock_destroy (ErlNifRWLock *rwlck);
...
extern ErlNifThreadOpts* enif_thread_opts_create (char *name) __attribute__((warn_unused_result));
extern void enif_thread_opts_destroy (ErlNifThreadOpts *opts);
...
extern void* enif_realloc (void* ptr, size_t size) __attribute__((alloc_size(2))) __attribute__((warn_unused_result));
extern void enif_system_info (ErlNifSysInfo *sip, size_t si_size);
extern int enif_fprintf (FILE* filep, const char *format, ...);
...
extern void * enif_alloc_resource (ErlNifResourceType *type, size_t size) __attribute__((malloc)) __attribute__((alloc_size(2))) __attribute__((warn_unused_result));
...
extern ErlNifEnv* enif_alloc_env (void) __attribute__((warn_unused_result));
...
extern int enif_make_reverse_list (ErlNifEnv*, ERL_NIF_TERM term, ERL_NIF_TERM *list);
extern int enif_is_number (ErlNifEnv*, ERL_NIF_TERM term);
extern void* enif_dlopen (const char* lib, void (*err_handler)(void*,const char*), void* err_arg);
extern void* enif_dlsym (void* handle, const char* symbol, void (*err_handler)(void*,const char*), void* err_arg);
extern int enif_consume_timeslice (ErlNifEnv*, int percent);
extern int enif_is_map (ErlNifEnv* env, ERL_NIF_TERM term);
extern int enif_get_map_size (ErlNifEnv* env, ERL_NIF_TERM term, size_t *size);
extern ERL_NIF_TERM enif_make_new_map (ErlNifEnv* env);
extern int enif_make_map_put (ErlNifEnv* env, ERL_NIF_TERM map_in, ERL_NIF_TERM key, ERL_NIF_TERM value, ERL_NIF_TERM* map_out);
extern int enif_get_map_value (ErlNifEnv* env, ERL_NIF_TERM map, ERL_NIF_TERM key, ERL_NIF_TERM* value);
extern int enif_make_map_update (ErlNifEnv* env, ERL_NIF_TERM map_in, ERL_NIF_TERM key, ERL_NIF_TERM value, ERL_NIF_TERM* map_out);
extern int enif_make_map_remove (ErlNifEnv* env, ERL_NIF_TERM map_in, ERL_NIF_TERM key, ERL_NIF_TERM* map_out);
extern int enif_map_iterator_create (ErlNifEnv *env, ERL_NIF_TERM map, ErlNifMapIterator *iter, ErlNifMapIteratorEntry entry);
extern void enif_map_iterator_destroy (ErlNifEnv *env, ErlNifMapIterator *iter);
extern int enif_map_iterator_is_head (ErlNifEnv *env, ErlNifMapIterator *iter);
extern int enif_map_iterator_is_tail (ErlNifEnv *env, ErlNifMapIterator *iter);
extern int enif_map_iterator_next (ErlNifEnv *env, ErlNifMapIterator *iter);
extern int enif_map_iterator_prev (ErlNifEnv *env, ErlNifMapIterator *iter);
extern int enif_map_iterator_get_pair (ErlNifEnv *env, ErlNifMapIterator *iter, ERL_NIF_TERM *key, ERL_NIF_TERM *value);
extern ERL_NIF_TERM enif_schedule_nif (ErlNifEnv*,const char*,int,ERL_NIF_TERM (*)(ErlNifEnv*,int,const ERL_NIF_TERM[]),int,const ERL_NIF_TERM[]);
extern int enif_has_pending_exception (ErlNifEnv *env, ERL_NIF_TERM* reason);
extern ERL_NIF_TERM enif_raise_exception (ErlNifEnv *env, ERL_NIF_TERM reason);
extern int enif_getenv (const char* key, char* value, size_t* value_size);
extern ErlNifTime enif_monotonic_time (ErlNifTimeUnit);
extern ErlNifTime enif_time_offset (ErlNifTimeUnit);
extern ErlNifTime enif_convert_time_unit (ErlNifTime, ErlNifTimeUnit, ErlNifTimeUnit);
extern ERL_NIF_TERM enif_now_time (ErlNifEnv *env);
extern ERL_NIF_TERM enif_cpu_time (ErlNifEnv *env);
extern ERL_NIF_TERM enif_make_unique_integer (ErlNifEnv *env, ErlNifUniqueInteger properties);
extern int enif_is_current_process_alive (ErlNifEnv *env);
extern int enif_is_process_alive (ErlNifEnv *env, ErlNifPid *pid);
extern int enif_is_port_alive (ErlNifEnv *env, ErlNifPort *port_id);
extern int enif_get_local_port (ErlNifEnv* env, ERL_NIF_TERM, ErlNifPort* port_id);
extern int enif_term_to_binary (ErlNifEnv *env, ERL_NIF_TERM term, ErlNifBinary *bin);
extern size_t enif_binary_to_term (ErlNifEnv *env, const unsigned char* data, size_t sz, ERL_NIF_TERM *term, unsigned int opts);
extern int enif_port_command (ErlNifEnv *env, const ErlNifPort* to_port, ErlNifEnv *msg_env, ERL_NIF_TERM msg);
extern int enif_thread_type (void);
extern int enif_snprintf (char * buffer, size_t size, const char *format, ...);
extern int enif_select (ErlNifEnv* env, ErlNifEvent e, enum ErlNifSelectFlags flags, void* obj, const ErlNifPid* pid, ERL_NIF_TERM ref);
extern ErlNifResourceType* enif_open_resource_type_x (ErlNifEnv*, const char* name_str, const ErlNifResourceTypeInit*, ErlNifResourceFlags flags, ErlNifResourceFlags* tried);
extern int enif_monitor_process (ErlNifEnv*,void* obj,const ErlNifPid*,ErlNifMonitor *monitor);
extern int enif_demonitor_process (ErlNifEnv*,void* obj,const ErlNifMonitor *monitor);
extern int enif_compare_monitors (const ErlNifMonitor*,const ErlNifMonitor*);
extern ErlNifUInt64 enif_hash (ErlNifHash type, ERL_NIF_TERM term, ErlNifUInt64 salt);
extern int enif_whereis_pid (ErlNifEnv *env, ERL_NIF_TERM name, ErlNifPid *pid);
extern int enif_whereis_port (ErlNifEnv *env, ERL_NIF_TERM name, ErlNifPort *port);

extern ErlNifIOQueue * enif_ioq_create (ErlNifIOQueueOpts opts) __attribute__((warn_unused_result));
extern void enif_ioq_destroy (ErlNifIOQueue *q);

extern int enif_ioq_enq_binary (ErlNifIOQueue *q, ErlNifBinary *bin, size_t skip);
extern int enif_ioq_enqv (ErlNifIOQueue *q, ErlNifIOVec *iov, size_t skip);

extern size_t enif_ioq_size (ErlNifIOQueue *q);
extern int enif_ioq_deq (ErlNifIOQueue *q, size_t count, size_t *size);

extern SysIOVec* enif_ioq_peek (ErlNifIOQueue *q, int *iovlen);

extern int enif_inspect_iovec (ErlNifEnv *env, size_t max_length, ERL_NIF_TERM iovec_term, ERL_NIF_TERM *tail, ErlNifIOVec **iovec);
extern void enif_free_iovec (ErlNifIOVec *iov);

extern int enif_ioq_peek_head (ErlNifEnv *env, ErlNifIOQueue *q, size_t *size, ERL_NIF_TERM *head);

extern char* enif_mutex_name (ErlNifMutex*);
extern char* enif_cond_name (ErlNifCond*);
extern char* enif_rwlock_name (ErlNifRWLock*);
extern char* enif_thread_name (ErlNifTid);

extern int enif_vfprintf (FILE*, const char *fmt, va_list);
extern int enif_vsnprintf (char*, size_t, const char *fmt, va_list);

extern int enif_make_map_from_arrays (ErlNifEnv *env, ERL_NIF_TERM keys[], ERL_NIF_TERM values[], size_t cnt, ERL_NIF_TERM *map_out);

extern int enif_select_x (ErlNifEnv* env, ErlNifEvent e, enum ErlNifSelectFlags flags, void* obj, const ErlNifPid* pid, ERL_NIF_TERM msg, ErlNifEnv* msg_env);
extern ERL_NIF_TERM enif_make_monitor_term (ErlNifEnv* env, const ErlNifMonitor*);
extern void enif_set_pid_undefined (ErlNifPid* pid);
extern int enif_is_pid_undefined (const ErlNifPid* pid);

extern ErlNifTermType enif_term_type (ErlNifEnv* env, ERL_NIF_TERM term);
extern ErlNifResourceType* enif_init_resource_type (ErlNifEnv*, const char* name_str, const ErlNifResourceTypeInit*, ErlNifResourceFlags flags, ErlNifResourceFlags* tried);
extern int enif_dynamic_resource_call (ErlNifEnv*, ERL_NIF_TERM mod, ERL_NIF_TERM name, ERL_NIF_TERM rsrc, void* call_data);

extern int enif_get_string_length (ErlNifEnv *env, ERL_NIF_TERM list, unsigned *len, ErlNifCharEncoding encoding);
extern int enif_make_new_atom (ErlNifEnv *env, const char *name, ERL_NIF_TERM *atom, ErlNifCharEncoding encoding);
extern int enif_make_new_atom_len (ErlNifEnv *env, const char *name, size_t len, ERL_NIF_TERM *atom, ErlNifCharEncoding encoding);
extern int enif_set_option (ErlNifEnv *env, ErlNifOption opt, ...);
# 440 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_nif_api_funcs.h"
...
static __inline__ ERL_NIF_TERM enif_make_tuple2(ErlNifEnv* env,
          ERL_NIF_TERM e1,
          ERL_NIF_TERM e2)
{
...
static __inline__ ERL_NIF_TERM enif_make_tuple3(ErlNifEnv* env,
          ERL_NIF_TERM e1,
          ERL_NIF_TERM e2,
          ERL_NIF_TERM e3)
{
...
static __inline__ ERL_NIF_TERM enif_make_tuple4(ErlNifEnv* env,
          ERL_NIF_TERM e1,
          ERL_NIF_TERM e2,
          ERL_NIF_TERM e3,
          ERL_NIF_TERM e4)
...
static __inline__ ERL_NIF_TERM enif_make_tuple5(ErlNifEnv* env,
          ERL_NIF_TERM e1,
          ERL_NIF_TERM e2,
          ERL_NIF_TERM e3,
          ERL_NIF_TERM e4,
...
static __inline__ ERL_NIF_TERM enif_make_tuple6(ErlNifEnv* env,
          ERL_NIF_TERM e1,
          ERL_NIF_TERM e2,
          ERL_NIF_TERM e3,
          ERL_NIF_TERM e4,
...
static __inline__ ERL_NIF_TERM enif_make_tuple7(ErlNifEnv* env,
          ERL_NIF_TERM e1,
          ERL_NIF_TERM e2,
          ERL_NIF_TERM e3,
          ERL_NIF_TERM e4,
...
static __inline__ ERL_NIF_TERM enif_make_tuple8(ErlNifEnv* env,
          ERL_NIF_TERM e1,
          ERL_NIF_TERM e2,
          ERL_NIF_TERM e3,
          ERL_NIF_TERM e4,
...
static __inline__ ERL_NIF_TERM enif_make_tuple9(ErlNifEnv* env,
          ERL_NIF_TERM e1,
          ERL_NIF_TERM e2,
          ERL_NIF_TERM e3,
          ERL_NIF_TERM e4,
...
static __inline__ ERL_NIF_TERM enif_make_list1(ErlNifEnv* env,
         ERL_NIF_TERM e1)
{
    return enif_make_list(env, 1, e1);
}

static __inline__ ERL_NIF_TERM enif_make_list2(ErlNifEnv* env,
         ERL_NIF_TERM e1,
         ERL_NIF_TERM e2)
{
...
static __inline__ ERL_NIF_TERM enif_make_list3(ErlNifEnv* env,
         ERL_NIF_TERM e1,
         ERL_NIF_TERM e2,
         ERL_NIF_TERM e3)
{
...
static __inline__ ERL_NIF_TERM enif_make_list4(ErlNifEnv* env,
         ERL_NIF_TERM e1,
         ERL_NIF_TERM e2,
         ERL_NIF_TERM e3,
         ERL_NIF_TERM e4)
...
static __inline__ ERL_NIF_TERM enif_make_list5(ErlNifEnv* env,
         ERL_NIF_TERM e1,
         ERL_NIF_TERM e2,
         ERL_NIF_TERM e3,
         ERL_NIF_TERM e4,
...
static __inline__ ERL_NIF_TERM enif_make_list6(ErlNifEnv* env,
         ERL_NIF_TERM e1,
         ERL_NIF_TERM e2,
         ERL_NIF_TERM e3,
         ERL_NIF_TERM e4,
...
static __inline__ ERL_NIF_TERM enif_make_list7(ErlNifEnv* env,
         ERL_NIF_TERM e1,
         ERL_NIF_TERM e2,
         ERL_NIF_TERM e3,
         ERL_NIF_TERM e4,
...
static __inline__ ERL_NIF_TERM enif_make_list8(ErlNifEnv* env,
         ERL_NIF_TERM e1,
         ERL_NIF_TERM e2,
         ERL_NIF_TERM e3,
         ERL_NIF_TERM e4,
...
static __inline__ ERL_NIF_TERM enif_make_list9(ErlNifEnv* env,
         ERL_NIF_TERM e1,
         ERL_NIF_TERM e2,
         ERL_NIF_TERM e3,
         ERL_NIF_TERM e4,
...
# 371 "/opt/homebrew/Cellar/erlang/26.2.5/lib/erlang/erts-14.2.5/include/erl_nif.h" 2
# 3 "niftest.c" 2
...
static ErlNifFunc nif_funcs[] =
{
 ...
 __attribute__ ((visibility("default"))) ErlNifEntry* nif_init(void); __attribute__ ((visibility("default"))) ErlNifEntry* nif_init(void) { static ErlNifEntry entry = { 2, 17, "Elixir.Niftest", sizeof(nif_funcs) / sizeof(*nif_funcs), nif_funcs, ((void *)0), ((void *)0), ((void *)0), ((void *)0), "beam.vanilla", 1, sizeof(ErlNifResourceTypeInit), "erts-14.0" }; ; return &entry; }
